# **Learning Experience (LX): Rendering on display**

# About these activities

In this tutorial, we will guide you on learning how to render text, graphs and messages on the Duckiebot display module
